      ...
      <li class="nav-item">
        ...
        <div id="collapseTables" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Select data:</h6>
      ...
      <div id="content">
        ...
        @foreach($produk as $pr)
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="nama_produk" required="required" value="{{ $pr->nama_produk }}"/>
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" name="harga_produk" required="required" value="{{ $pr->harga_produk }}"/>
                <div class="invalid-feedback">
                </div>
              </div>
